        ...
        <script type="text/javascript">
            ...
            function clickSearch(id){
                if(id == "searchCode"){
                    ...
                    itemGrid.clearAndLoad("load/blankList/blankListLoad_Search.php?gCode="+gCode+"&fields="+itemGridObj.fields, function(){
            ...
            function doOnListSelected(id){
                ...
                parent.dhxAccordR.cells("plan").attachURL('../productStructure/structure.php?rId='+rowId+'&itemId='+itemId+'&loginStatus=blank');
                parent.dhxAccordR.openItem("plan");
            }
            ...
            if(digit == "1"){
                ...
                //                }
                itemGrid.loadXML("load/blankList/s_blank_ListLoad.php?class="+gClass+"&type="+gType+"&group="+gGroup);
            }
        </script>
    </body>
</html>
