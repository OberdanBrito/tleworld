...
//------------------------------- Edit Data(below) -------------------------------
$field = "rowId,id,$sLang[0],$sLang[1],code,description,style";
$tb = $vArr[0];
$setWhere = "WHERE class='RawMat' OR class='Tool' OR class='WIP'";
//$setWhere = "WHERE class='Style' OR class='Template'";
