...
//if (!empty($sql)) {
//select ID item
    $query_item = mysql_query("SELECT id FROM productstructure WHERE rowId='558'");
//    $query_item = mysql_query($sql);
    ...
    $query_img = mysql_query("SELECT * FROM image WHERE refId='$itemId' ORDER BY rowId ASC");
...
//}
    echo "2. rowId == 558 & englishName == ooo & thaiName == ppp";
?>
