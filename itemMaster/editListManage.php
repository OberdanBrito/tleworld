...
//                        },
            ...
            itemGridData = [
                ...
                {fields:'code',aligns:'left',widths:'*',types:'ro',hides:false,enNames:'Code',thNames:'รหัส',filter:"#text_filter"},
...
//                }
                itemGrid.loadXML("load/editList/editListLoad.php?class="+gClass+"&type="+gType+"&group="+gGroup);
            }
        </script>
    </body>
</html>
