    ...
    <body>
        ...
        <script>
            ...
            var data =[{fields:'rowId',aligns:'left',widths:'50',types:'ro',hides:false,enNames:'Row ID',thNames:'Row ID'},
                ...
                {fields:'status',aligns:'left',widths:'100',types:'ch',hides:false,enNames:'Status',thNames:'Status'},
            ...
            priceStr.attachEvent("onRowSelect",function(id,ind){
                ...
                parent.dhxAccordR.cells("plan").attachURL("../price/priceReadOnly/priceReadOnly.php?priceStrId="+priceStr.cells(id,obj.id).getValue());
            ...
            priceStr.enableAutoSaving("priceReadOnlyGroup");
            priceStr.enableAutoSizeSaving();
            priceStr.loadSizeFromCookie("priceReadOnlyGroup");
