...
<html>
    ...
    <body>
        ...
        <script>
            ...
            addressGridData.enableHeaderMenu();
            ...
            // Form
            var codeDef="in_option=addressType";
            var addFormData = [  	
            ...
            addData = [
                ...
                {type: "fieldset",label: "allDet",inputWidth: 700,
                    list: [{type: "newcolumn"},{ type: "input",name:"",rows:3,value:"",inputWidth:500,label: "addrall"},
                        {type: "select", name:"addressType", labelLeft:"50",label: "addressType", connector:"PHP/codeDefLoad.php?"+codeDef},
