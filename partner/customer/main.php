...
//                tabbar.setContentHref("a4", "myform");
           ...
           tabbar.addTab("a1", "<img src='../image/Doc1.png' style='margin-top:1px;width:15px;height:15px;left:15px;'> <span style='margin-left:5px;font-weight:bold;'>General</span>", "160px"); 
            tabbar.addTab("a2", "<img src='../image/address.png' style='margin-top:1px;width:15px;height:15px;left:15px;'> <span style='margin-left:5px;font-weight:bold;'>Address</span>", "160px");
            tabbar.addTab("a3", "<img src='../image/contact.png' style='margin-top:1px;width:15px;height:15px;left:15px;'> <span style='margin-left:5px;font-weight:bold;'>Contact</span>", "160px");
