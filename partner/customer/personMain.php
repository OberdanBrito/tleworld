...
<html>
    ...
    <body >
        ...
        <script type="text/javascript">
            ...
            var sqlThN = loadSelectOpt+"field_cod=thaiName&type_cod=person_title&state="+state+"&gId="+getId+"&fieldP=title_th";
            var sqlEnN = loadSelectOpt+"field_cod=englishName&type_cod=person_title&state="+state+"&gId="+getId+"&fieldP=title";
            var sqlNation = loadSelectOpt+"field_cod="+lang+"&type_cod=nationality&state="+state+"&gId="+getId+"&fieldP=nationality";
            var sqlGen = loadSelectOpt+"field_cod="+lang+"&type_cod=gender&state="+state+"&gId="+getId+"&fieldP=gender";
 
            var data =[
                //----------------------------------- Type -----------------------------------
                {types:"fieldset",fields:"",keys:"fType",enLabels:getName,thLabels:getName},
                //                {types:"label",fields:"personType_show",keys:"perTypeS",enLabels:"",thLabels:""},
                {types:"input",fields:"personType",keys:"perType",enLabels:"",thLabels:""},
                
                //---------------------------------------- idCard ----------------------------------------
                {types:"fieldset",fields:"",keys:"fCard",enLabels:"Identity Card",thLabels:"บัตรประจำตัวประชาชน"},
                {types:"input",fields:"registerId",keys:"idNum",enLabels:"Id Number",thLabels:"เลขบัตรประชาชน"},
                //---Calendar
                {types:"label",fields:"issueRe_show",keys:"dateIS",enLabels:"Date of Issue",thLabels:"วันออกบัตร"},
                ...
                {types:"input",fields:"thaiName",keys:"thaiN_t",enLabels:"Name",thLabels:"ชื่อ"},
                {types:"input",fields:"thaiLastName",keys:"thaiLN_t",enLabels:"Last Name",thLabels:"นามสกุล"},
                ...
                {types:"input",fields:"englishName",keys:"thaiN_e",enLabels:"Name",thLabels:"ชื่อ"},
                {types:"input",fields:"englishLastName",keys:"thaiLN_e",enLabels:"Last Name",thLabels:"นามสกุล"},
                ...
                {types:"label",fields:"birthDate_show",keys:"bdS",enLabels:"Birth Date",thLabels:"วันเกิด"},
                        ...
                        {type:"hidden",name:"",label:"perType",value:getCode,inputWidth:80},
                        {
                            ...
                            list:[{
                                    ...
                                    list:[
                                        ...
                                        {type:"newcolumn",offset:0},
                                        {type:"calendar",name:"",label:"dateES",value:"",dateFormat:"%Y-%m-%d",serverDateFormat:"%Y-%m-%d",calendarPosition:"right",readonly:true,inputWidth:75},
                                        {type:"hidden",name:"",label:"dateE",value:""}]
                                }
                            ]
                        },
                        //-------------------- THAI --------------------
                            ...
                            list:[
                                {
                                    ...
                                    list:[
                                        ...
                                        {type:"newcolumn",offset:0},
                                        {type:selOpt,name:"",label:"genS",connector:sqlGen,inputWidth:"auto",offsetLeft:5},
                    ...
                    if (confirm(mes)==true){
                        if(id == "insert"){
                            ...
                            if(myForm.getItemValue("nationality") == null ){
                                getNation = myForm.getItemValue("nationality_show")+"|nationality";
                                getGender = myForm.getItemValue("gender_show")+"|gender";
                                comValue = getNation+","+getGender;
                                dhtmlxAjax.get("PHP/ajax/getCode.php?lang="+lang+"&getValue="+comValue,function(loader){
                                    ...
                                    myForm.setItemValue("gender",valGender);
                                    myForm.save();
                                });
                            }         
                        }else{
