...
<html>
    <head>
        <title>priceStructureGroup</title>
        ...
        <script>
            ...
            function onButtonClick(menuitemId, type) {
                ...
                if(menuitemId=="insert"){
                    parent.dhxAccordR.cells("plan").attachURL("../priceStructure/priceStructureN.php");
                    parent.dhxAccordR.openItem("plan");
                }else if(menuitemId=="edit"){
                    parent.dhxAccordR.cells("plan").attachURL("../priceStructure/pStrEdit.php?rowId="+priceStr.cells(rrId,0).getValue());
                    parent.dhxAccordR.openItem("plan");
                }
            }
            ...
            menu.loadXML("XML/priceStructureMenu.xml");
            ...
            var data =[{fields:'rowId',aligns:'left',widths:'50',types:'ro',hides:false,enNames:'Row ID',thNames:'Row ID'},
                ...
                {fields:'status',aligns:'left',widths:'100',types:'ch',hides:true,enNames:'Status',thNames:'Status'},
...
//                priceStr.setEditable(false);
            ...
            priceStr.enableAutoSaving("pricestrGroup");
            priceStr.enableAutoSizeSaving();
            priceStr.loadSizeFromCookie("pricestrGroup");
