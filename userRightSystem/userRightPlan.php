...
<html>
    ...
    <body>
        ...
        <div id="menuObj"><div id="right" width="48%" height="90%" style="float:left;padding-left: 10px;"></div></div>
        ...
        <script>
            ...
            menu.loadXML("XML/userRightMenu.xml");
