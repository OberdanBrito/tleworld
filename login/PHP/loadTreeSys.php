...
if ($lang == "English") {
    $tree->render_sql("SELECT * FROM menus WHERE userId='$uid' AND type='systemParameter'", "rowId", "englishName", "", "parentId");
} else if ($lang == "Thai") {
    $tree->render_sql("SELECT * FROM menus WHERE userId='$uid' AND type='systemParameter'", "rowId", "thaiName", "", "parentId");
}
?>