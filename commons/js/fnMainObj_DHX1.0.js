...
function cObject(){
    this.setBegin = function(a,b,c){
        ...
        this.lang=c=="English"?"enNames":"thNames";
        ...
        for(var index in b){
            for(var key in b[index]){
                ...
                if(key == "filter"){
                    this.filters[index] = this.values;
                }
            }
            if(this.filters.length != "0"){
                if(this.filters[index] == undefined){
                    this.filters[index] = "";
                }
            }
        }
        ...
        //        alert(this.filters.length);
        if(this.filters.length != "0"){
            a.attachHeader(this.filters.join());
        }
...
function fObject(){
    ...
    this.setBeginForm = function(a,b,c){
        this.lang=c=="English"?"enLabels":"thLabels";
        for(var index in a){
            this.i = "0";
